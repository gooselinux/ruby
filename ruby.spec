...
# Patch28 is not in the upstream VCS.  Where is the justification for it?
...
%exclude %{ruby_vendorarch}/%{rubyxver}/tcltklib.so
%exclude %{ruby_vendorarch}/%{rubyxver}/tkutil.so
...
%{_libdir}/libruby.so.*
%{ruby_vendorarch}/%{rubyxver}/*.so
%{ruby_vendorarch}/%{rubyxver}/digest
%{ruby_vendorarch}/%{rubyxver}/io
%{ruby_vendorarch}/%{rubyxver}/racc
%{ruby_vendorarch}/%{rubyxver}/rbconfig.rb
...
%{ruby_vendorarch}/%{rubyxver}/tcltklib.so
%{ruby_vendorarch}/%{rubyxver}/tkutil.so
